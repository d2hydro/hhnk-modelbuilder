...
gdalwarp /code/data/fixed_data/other/interception_ruw.tif /code/tmp/rasters/tmp/vulraster_interception_ruw.tif
...
gdal_calc.py --co="COMPRESS=DEFLATE" --NoDataValue -9999 -A /code/tmp/rasters/tmp/enenraster_ongec.tif -B /code/tmp/rasters/tmp/vulraster_interception_ruw.tif --outfile /code/tmp/rasters/tmp/vulraster_interception_ext.tif --calc="A*B"  
...
gdal_translate -co "COMPRESS=DEFLATE" /code/tmp/rasters/tmp/vulraster_interception_ext.tif /code/tmp/rasters/interception_sted.tif
